...
**panel_stone.png**
```
Pixel art authentique d'un panneau d'interface en pierre sombre avec une bordure de bronze ornée et un centre uni tuilable, format carré ~64x64 pixels, palette limitée (<=20 couleurs), aucun anti-aliasing, contours nets, style dark-fantasy donjon, coins extérieurs transparents, aucun texte. PNG.
```
